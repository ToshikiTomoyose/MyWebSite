...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>【確認】THEBBSアカウント新規作成</title>
                    ...
                    <nav id="fh5co-main-menu" role="navigation">
                        <ul>
                            <ul>
                                ...
                                <li class="fh5co-active"><a href="usercreate.html">アカウント新規登録</a></li>
                     ...
                     <div class="col-lg-8">
                        <div class="well bs-component">
                            ...
                            <div class="col-md-4 animate-box" data-animate-effect="fadeInLeft">
                                <h1 class="fh5co-heading-colored">これでいい？</h1>

                                <div class="row">
                                   <div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">

                                     	<p><button type="submit" class="btn btn-normal">よくないのだ！</button></p>
                                            <p><button type="submit" class="btn btn-primary">これでいいのだ。</button></p>
                                    </div>
                                </div>
                           </div>
